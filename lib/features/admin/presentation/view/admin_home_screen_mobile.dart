...
import 'package:manage_x/features/admin/presentation/widgets/admin_overview_chart_mobile.dart';

class AdminHomeScreenMobile extends StatefulWidget {
  const AdminHomeScreenMobile({super.key});

  @override
  State<AdminHomeScreenMobile> createState() => _AdminHomeScreenMobileState();
}

class _AdminHomeScreenMobileState extends State<AdminHomeScreenMobile> {
  @override
  void initState() {
    super.initState();
              ...
              SliverPadding(
                ...
                sliver: SliverList(
                  delegate: SliverChildListDelegate([
                    const AdminOverviewChartMobile(),
                    kheight20,

                    // Create Project Card (mobile style)
                ...
                child: Column(
                  ...
                  children: [
                    TextFormField(
                      ...
                      validator: (value) {
                        if (value == null || value.isEmpty) return 'Project name is required';
                    ...
                    Wrap(
                      ...
                      children: _priorities.map((priority) {
                        ...
                        return ChoiceChip(
                          ...
                          selectedColor: Color(int.parse(priority['color']!)).withOpacity(0.3),
...
class _EditProjectDialogState extends State<EditProjectDialog> {
  ...
  late String? _selectedLeadId = widget.project.assignedLeadId;
